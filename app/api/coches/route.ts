...
import { esChofer } from "@/lib/roles";

export const dynamic = "force-dynamic";

// GET /api/coches?q=1234ABC  -> búsqueda en tiempo real por matrícula o expediente
// Cualquier usuario autenticado y aprobado (incluidos los choferes) puede
// ver el listado; la RLS de Supabase (ver supabase/migracion.sql) lo
// exige igualmente como segunda barrera.
